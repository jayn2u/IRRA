...
def export_onnx_rstp():
    config_path = "/home/jayn2u/IRRA/irra_rstp/configs.yaml"
    model_path = "/home/jayn2u/IRRA/irra_rstp/best.pth"
    ...
    output_dir = "/home/jayn2u/IRRA/irra_rstp"
    ...
    img_onnx_path = os.path.join(output_dir, "irra_rstp_image_encoder.onnx")
    try:
        torch.onnx.export(
            img_enc,
            (dummy_image,),
    ...
    txt_onnx_path = os.path.join(output_dir, "irra_rstp_text_encoder.onnx")
    try:
        torch.onnx.export(
            txt_enc,
            (dummy_text,),
